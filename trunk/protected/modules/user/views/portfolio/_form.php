<article>
    ...
    <?php echo $form->errorSummary($portfolio);?>
    <h1>Edit portfolio image</h1>
        <img alt="26069_1393663162.medium" class="image" src="<?php echo Yii::app()->request->baseUrl . WWWROOT_FRONTEND . '/images/company/portfolio/thumb_' . $portfolio->path; ?>">
        <div class="meta-data">
            <div class="element">
            ...
            <div class="element">
                ...
                <select id="portfolio_image_industry_id" name="Portfolio[industry_id]">
                    ...
                    <?php foreach ($industries as $key => $industry) {?>
                            <option value="<?php echo $industry->id?>" <?php if(isset($portfolio->industry->id ) && $portfolio->industry->id == $industry->id) echo 'selected'?> ><?php echo $industry->name;?></option>
                    <?php } ?> 
                </select>
            </div>
            <div class="element">
                ...
                <select id="portfolio_image_technology_id" name="Portfolio[technology_id]">
                    ...
                    <?php foreach ($technologies as $key => $technology) {?>
                            <option value="<?php echo $technology->id?>" <?php if( isset($portfolio->technology->id ) && $portfolio->technology->id == $technology->id) echo 'selected'?>><?php echo $technology->name?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="element">
                ...
                <select id="portfolio_image_platform_id" name="Portfolio[platform_id]">
                    ...
                    <?php foreach ($platforms as $key => $platform) {?>
                            <option value="<?php echo $platform->id?>" <?php if( isset($portfolio->platform->id ) && $portfolio->platform->id == $platform->id) echo 'selected'?> ><?php echo $platform->name?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="element">
                ...
                <select id="portfolio_image_project_type_id" name="Portfolio[project_type_id]">
                    ...
                    <?php foreach ($projectypes as $key => $projectype) {?>
                            <option value="<?php echo $projectype->id?>" <?php if(isset($portfolio->projectType->id ) && $portfolio->projectType->id == $projectype->id) echo 'selected'?> ><?php echo $projectype->name?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
